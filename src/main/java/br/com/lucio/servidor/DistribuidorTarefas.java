...
public class DistribuidorTarefas implements Runnable {
    ...
    public DistribuidorTarefas(ExecutorService threadPool, BlockingQueue<String> filaComandos, Socket socket, ServidorTarefas servidorTarefas) {
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                switch (comando) {
                    ...
                    case "c3":
                        adicionaNafila(saidaCliente, comando);
                        break;
                    case "fim":
    ...
    private void comandoC2(PrintStream saidaCliente, String comando) {
        // Com as classes C2 implementando o Callable, conseguimos ter um retorno "Future" da thread
        saidaCliente.println("Confirmação comando " + comando);
    ...
    private void adicionaNafila(PrintStream saidaCliente, String comando) throws InterruptedException {
        saidaCliente.println("Confirmação comando " + comando);
        this.filaComandos.put(comando);  //bloqueante o numero de comandos definidos lá em cima
